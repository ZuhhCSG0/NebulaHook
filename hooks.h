...
//typedef void(*RenderViewFn) (IViewRender*, CViewSetup&, CViewSetup&, ClearFlags_t, RenderViewInfo_t);
...
//	extern void __fastcall RenderView(IViewRender* this0, void* EDX, CViewSetup& view, CViewSetup& hudViewSetup,
//		ClearFlags_t nClearFlags, RenderViewInfo_t whatToDraw);
	...
	float __stdcall H_GetViewModelFOV();
	...
	extern HRESULT _stdcall Present(IDirect3DDevice9* pDevice, RECT* pSourceRect, RECT* pDestRect, HWND hDestWindowOverride, RGNDATA* pDirtyRegion);
