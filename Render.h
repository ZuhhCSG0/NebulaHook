...
public:
	...
	void FillARGBTriangle(int x1, int y1, int x2, int y2, int x3, int y3, D3DCOLOR color);


	void BorderBoxOutlinedText2(int x, int y, int w, int h, int thickness, D3DCOLOR color, D3DCOLOR outlined, char* meme, LPD3DXFONT font);

	void BorderBoxOutlinedText(int x, int y, int w, int h, int thickness, D3DCOLOR color, D3DCOLOR outlined, char* meme, LPD3DXFONT font);
