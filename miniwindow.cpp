...
void MMiniWindow::Draw()
{
	...
	int dragyoffset = m_pMenu->MainWindow->dragYoffset/2 + 3;
	...
	*/
	...
	g_pRender->String(this->position.x + this->size.x / 2, this->position.y + (dragyoffset / 2), centered, g_pRender->Fonts.menu_control, true, WHITE(alpha), "%s", this->name.c_str());
