...
public:
	...
	bool IsGlove()
	{
		...
		return (iWeaponID == 5028 || iWeaponID == 5029 || iWeaponID == 5027 || iWeaponID == 5030 || iWeaponID == 5031 || iWeaponID == 5032 || iWeaponID == 5033 || iWeaponID == 5034);
	}
...
public:
	...
	void OnDataUpdate(int updateType)
	{
		PVOID pNetworkable = (PVOID)((DWORD)(this) + 0x8);
		typedef void(__thiscall* OriginalFn)(PVOID, int);
		return getvfunc<OriginalFn>(pNetworkable, 5)(pNetworkable, updateType);
	}
