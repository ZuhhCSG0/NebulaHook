...
void SetupOffsets()
{
	...
	offys.m_bHasHeavyArmor = g_pNetVars->GetOffset("DT_CSPlayer", "m_bHasHeavyArmor");

	offys.m_vecViewOffset = g_pNetVars->GetOffset("DT_BasePlayer", "m_vecViewOffset[0]");


	offys.m_iPrimaryReserveAmmo = g_pNetVars->GetOffset("DT_BaseCombatWeapon", "m_iPrimaryReserveAmmoCount");
	...
	offys.m_nSequence2 = g_pNetVars->GetOffset(XorStr("DT_BaseAnimating"), XorStr("m_nSequence"));
