...
void MWindow::Draw()
{
	...
	//g_pRender->BorderedBox(x - 4, y - 4, w + 8, h + 8, D3DCOLOR_RGBA(45, 45, 45, 255));
	//g_pRender->BorderedBox(x - 3, y - 3, w + 6, h + 6, D3DCOLOR_RGBA(60, 60, 60, 255));
	//g_pRender->BorderedBox(x - 2, y - 2, w + 4, h + 4,  D3DCOLOR_RGBA(75, 75, 75, 255));
	//g_pRender->BorderedBox(x - 1, y - 1, w + 2, h + 2, D3DCOLOR_RGBA(29, 29, 29, 255));

	g_pRender->FilledBox(this->position.x, this->position.y, this->size.x, this->size.y, D3DCOLOR_ARGB(alpha, 25, 25, 25));
	g_pRender->BorderedBox(this->position.x - 1, this->position.y - 1, this->size.x + 2, this->size.y + 2, BLACK(alpha));
	g_pRender->BorderedBox(this->position.x + 10, this->position.y + 25, this->size.x - 20, this->size.y - 40, BLACK(alpha));
...
/*	g_pRender->BorderedBox(this->position.x - 1, this->position.y - 1, this->size.x + 2, this->size.y + 2, BLACK(alpha));
	...
	g_pRender->Text((char*)this->name.c_str(), this->position.x + this->size.x / 2, this->position.y + 7, text_alignment::centered, g_pRender->Fonts.menu_control, false, D3DCOLOR_RGBA(255, 255, 255, 255), D3DCOLOR_RGBA(255, 255, 255,255));
