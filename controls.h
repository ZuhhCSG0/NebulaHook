...
public:
	...
	MGroupbox2* Save_Box = nullptr;
	MSavePanel* SavePanel = nullptr;
	//MListBox* SaveList = nullptr;
};
class CVisualElements
{
public:
	MCategory* VisualCat;
	MGroupbox2* Visual_Player;
	...
	MCheckbox* Visual_Misc_FChams;
	MCheckbox* Visual_Misc_NoRecoil;
	MDropdown* Visual_Misc_Hitmaker;
	MCheckbox* Visual_Misc_GrenadePrediction;

	MCheckbox* Visual_Misc_Beams;
};
...
public:
	...
	MGroupbox2* Ragebot_Main = nullptr;
	MCheckbox* Ragebot_Active = nullptr;
	MCheckbox* Ragebot_Type = nullptr;
	...
	MGroupbox2* Ragebot_Selection = nullptr;
	...
	MCheckbox* Ragebot_Multipoint = nullptr;
	...
	MGroupbox2* Ragebot_Accuracy = nullptr;
	...
	MGroupbox2* Ragebot_AntiAim = nullptr;
