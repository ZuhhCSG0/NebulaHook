...
void CDraw::Init()
{
	...
	g_pSurface->SetFontGlyphSet(font_esp, XorStr("Verdana"), 11, 700, 0, 0, FONTFLAG_OUTLINE);
	...
	g_pSurface->SetFontGlyphSet(font_build, XorStr("Verdana"), 27, FW_EXTRABOLD, 0, 0, FONTFLAG_OUTLINE | FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
